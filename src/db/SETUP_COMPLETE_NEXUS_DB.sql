...
CREATE TABLE IF NOT EXISTS public.trainees (
    ...
    profile_completion_pct INT NOT NULL DEFAULT 30 CHECK (profile_completion_pct >= 0 AND profile_completion_pct <= 100),
...
CREATE TABLE IF NOT EXISTS public.trainee_employment (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'self_employed',
...
CREATE TABLE IF NOT EXISTS public.trainee_followups (
    ...
    current_status VARCHAR(100) DEFAULT 'self_employed',
    current_income_range VARCHAR(50) DEFAULT '₹15,000 – ₹25,000',
    job_satisfaction_score INT DEFAULT 5,
    skill_utilization_score INT DEFAULT 5,
