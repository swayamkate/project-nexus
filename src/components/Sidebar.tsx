...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const currentMenuItems: MenuItem[] = [
    ...
    { id: 'career-goal', label: t('nav.careerGoal', 'Career Goal & Skill Gap'), icon: Target, isNew: true },
    { id: 'career-roadmap', label: t('nav.careerRoadmap', 'Action Roadmap (N Days)'), icon: Compass, isNew: true },
    { id: 'courses', label: t('nav.courses', 'Course Search (NPTEL/Coursera)'), icon: BookOpen, isNew: true },
    { id: 'skill-assessments', label: t('nav.assessments', 'Skill Assessments'), icon: Award, isNew: true },
    { id: 'interview-prep', label: t('nav.interviewPrep', 'Interview Prep & Q&A'), icon: Briefcase, isNew: true },
