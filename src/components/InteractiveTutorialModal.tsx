      ...
      <div className="bg-[#0a1020] border border-slate-800 rounded-3xl max-w-2xl w-full shadow-2xl overflow-hidden animate-in zoom-in-95 flex flex-col max-h-[90vh]">
        ...
        <div className="p-5 sm:p-6 border-b border-slate-800 flex items-center justify-between bg-slate-900/60">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-extrabold text-white text-base">CareerLoop System Guide & Interactive Walkthrough</h3>
              <p className="text-xs text-slate-400">Step-by-step interactive workflow tutorial</p>
            </div>
          </div>
        ...
        {/* Track Selector (Candidate vs. Administrator) */}
        <div className="p-4 bg-black/40 border-b border-slate-800/80 flex items-center justify-center gap-2">
          ...
          >
            ...
            <span>Administrator & Evaluator Track</span>
          </button>
        </div>
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 flex-1">
            ...
            {currentSteps.map((step, idx) => (
              <div 
                ...
                className={`h-2 flex-1 rounded-full transition-all cursor-pointer ${
                  activeStep === idx 
                    ? 'bg-gradient-to-r from-blue-500 to-indigo-500 ring-2 ring-blue-400/40' 
                    : idx < activeStep 
                    ? 'bg-emerald-500' 
                    : 'bg-slate-800'
                }`}
          ...
          <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            <div className="p-3.5 bg-black/40 border border-slate-800/80 rounded-xl text-xs space-y-1">
              <span className="text-[10px] font-bold uppercase tracking-wider text-blue-400 block">How to Execute:</span>
        ...
        <div className="p-5 border-t border-slate-800 bg-slate-900/60 flex items-center justify-between">
          ...
          {activeStep < currentSteps.length - 1 ? (
            <button
              ...
              className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition flex items-center space-x-1 shadow-md shadow-blue-600/20 cursor-pointer"
            >
              <span>Next Step</span>
