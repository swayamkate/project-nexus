...
export const SETTING_TYPES = {
  ...
  'analytics.show_personal_wage_chart': z.boolean(),
  'analytics.show_district_benchmarks': z.boolean(),
  'analytics.show_skill_gaps': z.boolean(),
  'analytics.wage_chart_title': z.string().min(1).max(120),
  'analytics.benchmark_title': z.string().min(1).max(120),
  'analytics.skill_gap_title': z.string().min(1).max(120),
