              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between lg:justify-end gap-4 lg:w-96">
                    ...
                    {isCompleted ? (
                      <button 
                        onClick={() => alert(`Details for ${item.name}: ${item.remarks}`)}
                        className="px-3.5 py-1.5 rounded-xl border border-slate-700 text-slate-300 hover:bg-slate-800 text-xs font-semibold flex items-center space-x-1.5 shrink-0"
                      >
                      ...
                      <button 
                        ...
                        className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition shadow-md shadow-blue-600/20 flex items-center space-x-1.5 shrink-0"
                      >
                  ...
                  <td className="py-3.5 text-right">
                    {row.status === 'Completed' ? (
                      <button 
                        ...
                        className="px-2.5 py-1 rounded-lg border border-slate-700 text-slate-300 hover:bg-slate-800 text-[11px] font-semibold inline-flex items-center space-x-1"
                      >
