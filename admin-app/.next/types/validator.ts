...
// Validate ../../src/app/api/auth/superadmin/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/superadmin">> = Specific
  const handler = {} as typeof import("../../src/app/api/auth/superadmin/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
